  ...
  return (
    <section id="contact">
        <div className="flex flex-col lg:flex-row">
            <a href="#"
                style={{ transition: `width 1s ease`,backgroundImage: `url(https://listlabs.com/wp-content/uploads/2022/10/investors_contact.png)`}} 
                className={`
                group
                py-24 lg:py-48
                ...
                text-white`}>
                    <p className="uppercase text-lg text-center  tracking-[0.2em] font-black">
            ...
            <a href="#"
                style={{ transition: `width 1s ease`,backgroundImage: `url(https://listlabs.com/wp-content/uploads/2022/10/partners_contact.png)`}} 
                className={`
                group
                py-24 lg:py-48
                w-full lg:w-1/2 lg:hover:w-2/3 lg:peer-hover:w-1/3 
